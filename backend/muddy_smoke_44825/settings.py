"""
Django settings for muddy_smoke_44825 project.
...
ROOT_URLCONF = 'muddy_smoke_44825.urls'
...
WSGI_APPLICATION = 'muddy_smoke_44825.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_smoke_44825 API",
    "DESCRIPTION": "API documentation for muddy_smoke_44825 App",
    "VERSION": "v1",
}
